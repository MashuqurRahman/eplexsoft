...
from .choices import PRODUCT_STATUS_CHOICES, PAYMENT_STATUS_CHOICES, ORDER_STATUS_CHOICES, DELIVERY_DISCOUNT_TYPE_CHOICES, DELIVERY_LOCATION_CHOICES, PRODUCT_APPROVAL, STEADFAST_STATUS_CHOICES, PATHAO_STATUS_CHOICES, REDX_STATUS_CHOICES, COLUMN_CHOICES
...
class Product(models.Model):
    ...
    sub_sub_categories = models.ForeignKey(SubSubCategories, on_delete=models.PROTECT, related_name='product_sub_sub_categories', blank=True, null=True)
...
class SiteSetting(models.Model):
    ...
    messenger = models.URLField(max_length=500, blank=True, null=True)
