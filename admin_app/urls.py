...
urlpatterns = [
    ...
    path('orders/items/<int:item_id>/resolve/', order_views.resolve_stock_violation, name='resolve_stock_violation'), 
    ...
    path('ajax/load-subcategories-has-sub-sub-category/', ajax_views.load_sub_category_based_on_sub_sub_category, name='ajax_load_subcategories_based_on_sub_sub_category'),
