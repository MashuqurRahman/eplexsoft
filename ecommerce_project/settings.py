...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.environ.get('DJANGO_DB_NAME', 'eplexsoft_eplex_demo_db'),
        'USER': os.environ.get('DJANGO_DB_USER', 'eplexsoft_eplexsoft'),
        'PASSWORD': os.environ.get('DJANGO_DB_PASSWORD', 'eplexsoft@eplexsoft'),
